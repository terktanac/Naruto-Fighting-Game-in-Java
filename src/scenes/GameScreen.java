...
//				Main.setDefault();
	...
	public final void setCharacter(int choose1, int choose2) {
		...
		if (choose1 == 0) {
			...
			healthbarP1 = new HealthBar(800, 312.5,
					new ImageView(new Image(
							ClassLoader.getSystemResource("characters/naruto_sage/naruto_sage_s.png").toString(), 348,
							140, true, false)),
					-25, -50);
		} else {
			...
			healthbarP1 = new HealthBar(800, 312.5,
					new ImageView(new Image(
							ClassLoader.getSystemResource("characters/sasuke_aka/sasuke_aka_s.png").toString(), 348,
							140, true, false)),
					-25, -50);
		}
		if (choose2 == 0) {
			player2 = new Naruto(Character.getMaxHealth());
			healthbarP2 = new HealthBar(800, 312.5,
					new ImageView(new Image(
							ClassLoader.getSystemResource("characters/naruto_sage/naruto_sage_s.png").toString(), 348,
							140, true, false)),
					5, -50);
