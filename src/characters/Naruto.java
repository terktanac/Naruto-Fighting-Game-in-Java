...
public class Naruto extends Character {
	...
	public final int basic_skill(Character target, ArrayList<GameObject> playerObject) {
		if (isSkill1()) {
			if (getSkillDelay() >= 200) {
				getImageview().setViewport(new Rectangle2D(0, 1221, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= 180) {
				getImageview().setViewport(new Rectangle2D(111, 1221, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= 160) {
				getImageview().setViewport(new Rectangle2D(222, 1221, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() > 140) {
				getImageview().setViewport(new Rectangle2D(333, 1221, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() == 140) {
				getImageview().setViewport(new Rectangle2D(333, 1221, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
				...
				getImageview().setViewport(new Rectangle2D(444, 1441, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= -20) {
				getImageview().setViewport(new Rectangle2D(555, 1441, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.25);
			} else if (getSkillDelay() >= -40) {
				getImageview().setViewport(new Rectangle2D(666, 1441, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= -60) {
				getImageview().setViewport(new Rectangle2D(777, 1441, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() > -80) {
				getImageview().setViewport(new Rectangle2D(888, 1441, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() == -80) {
				getImageview().setViewport(new Rectangle2D(888, 1441, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
				...
				getImageview().setViewport(new Rectangle2D(999, 1441, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else {
	...
	public final int mid_skill(Character target, ArrayList<GameObject> playerObject) {
		if (isSkill2()) {
			if (getSkillDelay() >= 200) {
				getImageview().setViewport(new Rectangle2D(0, 1665, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= 180) {
				getImageview().setViewport(new Rectangle2D(111, 1665, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= 160) {
				getImageview().setViewport(new Rectangle2D(222, 1665, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= 140) {
				getImageview().setViewport(new Rectangle2D(333, 1665, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= 120) {
				getImageview().setViewport(new Rectangle2D(111, 1665, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
				...
				getImageview().setViewport(new Rectangle2D(444, 1665, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= -20) {
				getImageview().setViewport(new Rectangle2D(555, 1665, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= -40) {
				getImageview().setViewport(new Rectangle2D(666, 1665, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= -60) {
				getImageview().setViewport(new Rectangle2D(777, 1665, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() > -80) {
				getImageview().setViewport(new Rectangle2D(888, 1665, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() == -80) {
				getImageview().setViewport(new Rectangle2D(888, 1665, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
				...
				getImageview().setViewport(new Rectangle2D(999, 1665, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else {
				target.setStackFly(1);
	...
	public int High_skill(Character target, ArrayList<GameObject> playerObject) {
		if (isSkill3()) {
			if (getSkillDelay() == 250) {
				getImageview().setViewport(new Rectangle2D(0, 1887, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
				rasenshuriken.play();
			}
				...
				getImageview().setViewport(new Rectangle2D(111, 1887, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= 160) {
				getImageview().setViewport(new Rectangle2D(222, 1887, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= 140) {
				getImageview().setViewport(new Rectangle2D(333, 1887, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= 120) {
				getImageview().setViewport(new Rectangle2D(111, 1887, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
				...
				getImageview().setViewport(new Rectangle2D(444, 1887, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= -20) {
				getImageview().setViewport(new Rectangle2D(555, 1887, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= -40) {
				getImageview().setViewport(new Rectangle2D(666, 1887, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= -60) {
				getImageview().setViewport(new Rectangle2D(777, 1887, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= -80) {
				getImageview().setViewport(new Rectangle2D(888, 1887, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= -100) {
				getImageview().setViewport(new Rectangle2D(555, 1887, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
				...
				getImageview().setViewport(new Rectangle2D(999, 1887, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= -200) {
				getImageview().setViewport(new Rectangle2D(0, 1998, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= -220) {
				getImageview().setViewport(new Rectangle2D(111, 1998, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() > -240) {
				getImageview().setViewport(new Rectangle2D(222, 1998, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() == -240) {
				getImageview().setViewport(new Rectangle2D(222, 1998, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
				...
				getImageview().setViewport(new Rectangle2D(0, 1554, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else if (getSkillDelay() >= -280) {
				getImageview().setViewport(new Rectangle2D(111, 1554, getCharacterWidth() - 15, getCharacterHeight() - 1.3));
				setSkillDelay(getSkillDelay() - 0.5);
			} else {
